...
export const abloom: AbloomProject = {
  name: "Abloom",
  ...
  overview: {
    title: "Abloom -",
    subtitle: "Awesomely blossom with nature",
    paragraphs: [
  ...
  highlights: {
    ...
    items: [
      ...
      "Spread over 3 acres",
      "Only 10 plots of equal size",
      "Ready infrastructure",
      "Nashik and Trambakeshwar temple at short driving distance",
    ],
  },
  unitInfrastructure: {
    title: "Unit Infrastructure",
    description:
      "Each unit plot comes with ready facilities, allowing you to envision your second home without the worry of basic setup. This reduces overheads significantly and saves valuable time when you begin living in your dream home.",
    brandBlurb:
      "A company of passionate realtors transforming landscapes into landmarks, offering exceptional value with innovative concepts and investment options. With over two decades of experience, our vision is to build projects in the lap of nature that bring people closer to what they truly desire.",
  },
  gallery: {
    title: "Gallery",
    subtitle: "Project",
