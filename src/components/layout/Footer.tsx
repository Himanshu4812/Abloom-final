      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="hidden md:grid md:grid-cols-12 gap-8 pb-6 pt-8">
          <div className="col-span-5">
            <h4 className="text-forest/40 text-[13px] font-sans tracking-widest uppercase italic">(Get in touch)</h4>
          </div>
          <div className="col-span-3">
            <h4 className="text-forest/40 text-[13px] font-sans tracking-widest uppercase italic">(Location)</h4>
          </div>
          <div className="col-span-4">
            <h4 className="text-forest/40 text-[13px] font-sans tracking-widest uppercase italic">(Contact)</h4>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 pt-8 pb-16">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-pangaia font-bold text-forest tracking-tight">HIRANMAYI</h2>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:hiranmayi0422@gmail.com" className="text-forest text-base md:text-lg font-pangaia italic tracking-wide hover:opacity-70 transition-opacity uppercase">
                HIRANMAYI0422@GMAIL.COM
              </a>
              <a href="tel:+919766180144" className="text-forest text-base md:text-lg font-pangaia italic tracking-wide hover:opacity-70 transition-opacity">
                +91 976 618 0144
              </a>
            </div>
          </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="flex flex-col md:flex-row justify-between items-center text-[11px] text-forest/40 font-sans font-light mt-8 tracking-wide"
        >
