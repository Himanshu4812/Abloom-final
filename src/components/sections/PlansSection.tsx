...
const masterplanData = [
  {
    ...
    subtitle: 'Uncompromising Exclusivity',
    description: 'A meticulously sculpted eco-estate spread across 3 pristine acres. Limited to exactly 10 equal-sized plots, the layout is engineered to maximize individual privacy while fostering a deeply harmonious community.',
    area: '3 Acres Total Coverage',
    amenities: '10 Equal Plots, Vastu-Compliant Orientation',
    imageUrl: '/images/plan/plan_blueprint.webp',
  },
  {
    id: 'nature',
    title: 'The Sanctuary',
    subtitle: 'A Lifeline to Nature',
    description: 'Immerse yourself in a curated, deeply rejuvenating wilderness. Situated alongside a calming riverfront, the estate serves as a living, breathing retreat shaded by ancient trees and dappled golden sunlight.',
    area: 'Prime Riverfront & Canopy',
    amenities: 'Curated Walking Trails, Riverside Meditation Zones',
    imageUrl: '/images/plan/plan_sanctuary.webp',
  },
  {
    id: 'infrastructure',
    ...
    imageUrl: '/images/plan/hq-masterplan-3.webp',
  },
  {
    id: 'seclusion',
    title: 'Strategic Seclusion',
    ...
    imageUrl: '/images/plan/plan_seclusion.webp',
  },
];
