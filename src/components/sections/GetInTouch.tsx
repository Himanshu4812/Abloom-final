...
export const GetInTouch = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    setTimeout(() => {
      const text = `Hello Abloom Team,

I would like to inquire about the plots.
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden bg-[#FDFBF7]">
        ...
        {/* Faint topographic contour lines on far left (Simulated with SVG pattern) */}
        <div className="absolute top-0 left-0 w-1/3 h-full opacity-5 mix-blend-multiply" 
             style={{ backgroundImage: 'radial-gradient(circle at 0% 50%, transparent 20%, #1B5E20 21%, transparent 22%, transparent 40%, #1B5E20 41%, transparent 42%, transparent 60%, #1B5E20 61%, transparent 62%, transparent 80%, #1B5E20 81%, transparent 82%)', backgroundSize: '200px 200px' }}>
        </div>

        {/* Faded architectural blueprint texture on far right */}
        <div className="absolute top-0 right-0 w-1/3 h-full opacity-[0.03] mix-blend-multiply" 
        ...
        {/* CENTER VILLA IMAGE - Blends organically, sits behind left/right sections */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center h-full">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center h-full pt-10 pb-6 lg:py-0">
            <div className="mb-6">
              ...
              <h2 ref={headingRef} className="text-4xl md:text-5xl lg:text-6xl font-serif font-light text-forest mb-5 leading-[1.1] -ml-1">
                <span className="word inline-block opacity-0">Let's</span>{' '}
                <span className="word inline-block opacity-0">Build</span>{' '}
                <span className="word inline-block opacity-0">Your</span>
                <br />
                <span className="word inline-block opacity-0">Dream</span>{' '}
                <span className="word inline-block opacity-0 text-primary font-serif italic font-light">Sanctuary.</span>
              </h2>
              ...
              >
                Begin your journey toward an exclusive eco-luxury lifestyle. Let us craft your perfect sanctuary surrounded by nature, comfort and elegance.
              </motion.p>
            </div>
            ...
            >
              {[
                { icon: MapPin, label: 'Office Address', detail: '41, Le Regalia Township, 6th Floor,\nB-Wing, Ambad Link Road, Nashik' },
                { icon: Phone, label: 'Direct Line', detail: '+91 976 618 0144' },
                { icon: Clock, label: 'Visit Hours', detail: 'Mon – Sat : 10 AM – 7 PM\nBy appointment only' },
                { icon: Mail, label: 'Email', detail: 'hiranmayi0422@gmail.com' },
              ].map((item, idx) => (
                <div key={idx} className={`flex items-start gap-5 group py-4 ${idx !== 0 ? 'border-t border-forest/5' : ''}`}>
                  <div className="w-10 h-10 rounded-full bg-mint/30 flex items-center justify-center shrink-0 group-hover:bg-mint/50 transition-colors duration-500">
                    <item.icon className="w-4 h-4 text-forest/70 group-hover:text-forest transition-colors duration-500" strokeWidth={1.5} />
                  </div>
                  <div className="pt-0.5">
                    <p className="text-xs text-forest/50 uppercase tracking-widest mb-1 font-sans font-semibold">{item.label}</p>
                  ...
                  >
                    <div className="mb-8">
                      <img
                        ...
                        loading="lazy"
                      />
                      <h3 className="text-2xl md:text-3xl font-serif text-[#1B5E20] mb-2">Tell us about your dream property.</h3>
                      <p className="text-[#1B5E20]/80 font-sans text-sm font-light">Our team will get in touch with you shortly.</p>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative group">
                        ...
                        {errors.message && <p className="text-red-400 text-xs mt-1 ml-2">{errors.message.message}</p>}
                      </div>
                    </div>
                    ...
                    <div className="pt-2">
                      ...
                      >
                        ...
                        <ArrowRight className="w-4 h-4 relative z-10 group-hover/btn:translate-x-1 transition-transform duration-300" strokeWidth={2} />
                      </button>

                      {/* SECONDARY CTA */}
                      <div className="flex items-center gap-3 my-5">
                        <div className="flex-1 h-[1px] bg-forest/5" />
                        <span className="text-xs font-sans font-semibold text-forest/40 uppercase tracking-widest">Or Connect Instantly</span>
                        <div className="flex-1 h-[1px] bg-forest/5" />
                      </div>
                      ...
                      >
                        <svg className="w-4 h-4 text-forest group-hover/wa:text-primary transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="text-forest font-sans text-sm font-medium group-hover/wa:text-primary transition-colors duration-300">Continue on WhatsApp</span>
                      </button>
                    </div>
                  </motion.form>
                ) : (
